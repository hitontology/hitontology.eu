...
export const COMPETENCE_AREAS = {
	ast: {
		...
		competenceProperty: "hito:competencyAstCla",
		property: "hito:spIsOfAstCla",
	},
	swp: {
		...
		endpoint: ENDPOINT_HITO,
		competenceProperty: "hito:competencySoftwareProduct",
		property: "hito:",
	},
	interoperability: {
		...
		endpoint: ENDPOINT_HITO,
		competenceProperty: "hito:competencyInteroperability",
		property: "hito:interoperability",
	},
	...
	programmingLanguage: {
		...
		competenceProperty: "hito:competencyProgrammingLanguage",
		property: "hito:programmingLanguage",
		endpoint: ENDPOINT_HITO,
	},
	programmingLibrary: {
		...
		property: "hito:programmingLibrary",
	},
	language: {
		label: "Language",
		plural: "languages",
		...
		competenceProperty: "hito:competencyLanguage",
		property: "hito:language",
		endpoint: ENDPOINT_HITO,
	},
	db: {
		...
		competenceProperty: "hito:competencyDb",
		property: "hito:databaseManagementSystem",
		endpoint: ENDPOINT_HITO,
	},
	certification: {
		label: "Certification",
	...
	enterpriseFunction: {
		...
		competenceProperty: "hito:competencyEfCla",
		property: "hito:spSupportsEfCla",
		endpoint: ENDPOINT_HITO,
	},
	enterpriseFunctionWhoDhi: {
	...
	enterpriseFunctionBb: {
		...
		label: "Enterprise Function from 'Health Information Systems'",
		plural: "enterprise functions",
	...
	featureBb: {
		...
		label: "Feature from 'Health Information Systems'",
		plural: "features",
	...
	featureJoshiPacs: {
		...
		label: "Feature from 'PACS Administrators’ and Radiologists’ Perspective...'",
		plural: "features",
	...
	userGroup: {
		...
		competenceProperty: "hito:competencyUserCit",
		property: "hito:spUsedByUserCla",
		endpoint: ENDPOINT_HITO,
	},
	organizationalUnit: {
	...
	role: {
		...
		competenceProperty: "hito:competencyRole",
